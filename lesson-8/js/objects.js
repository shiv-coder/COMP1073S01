...
const person = {
    ...
    age: 30,
    gender: "Female",
    interests:["Swimming","dancing","Camping"],
    greeting(){
        // alert(`Hi, I am ${this.namee.first} and I am ${this.age} years old and I enjoy ${this.interests[0]}`);
        let greeting = `Hi, I am ${this.namee.first} and I am ${this.age} years old and I enjoy ${this.interests[0]}`
        return greeting;
    }
};
...
person.Goodbye = function(){
    let goodbye = `${this.namee.first} says goodbye`;
    return goodbye;
}

/* STEP 10: We can also dynamically set both names and values for objects (using bracket syntax)… */

const dataName = "Address";
const dataValue = "Georgian College";
