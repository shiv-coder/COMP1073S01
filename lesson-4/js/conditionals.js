...
if(homeWorkDone === false){
	breakduration = 10;
	console.log("The breakduration is " + breakduration + " minutes as homeWork is not done.");
} else{
	breakduration = 45;
	console.log("The breakduration is " + breakduration + " minutes as homeWork is done succesfully.");
}
...
console.log(typeof(NaN));console.log(isNaN(NaN));
...
coffeeBreak ? breakMessage.textContent = 'BreakTime' : breakMessage.textContent = 'Keeporking';
